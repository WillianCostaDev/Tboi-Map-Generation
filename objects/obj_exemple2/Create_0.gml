...
Init_WolrdGen(tile_size,tile_size,spr_room_normal,spr_room_normal,"normal",obj_door,4,tile_size*4,tile_size*2)
...
Add_Room_To_Gen("Boss",spr_room_normal,last,100,1,1,c_red)
Add_Room_To_Gen("Shop",spr_room_normal,perpendicular,100,1,1,c_yellow)
