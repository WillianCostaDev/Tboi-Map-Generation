if sprite_index = noone or color = noone or object = noone{
	instance_destroy()
	return;
}
	...
	for( var ii=0;ii<sprite_height;ii++)
			...
			var _x = i,
				...
				if make_colour_rgb(r,g,b) = color{
					var colid = instance_create_depth(x+_x*32,y-16+_y*32,depth,object)
					colid.image_xscale = 1
					colid.image_yscale = 1
				}	
